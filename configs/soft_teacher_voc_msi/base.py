...
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            #     keep_ratio=True,
            # ),
            dict(type='RandResize', img_scale=image_size, ratio_range=(0.5, 1.5), keep_ratio=True),
...
evaluation = dict(type="MSISubModulesDistEvalHook", interval=4000, evaluated_modules=['teacher'],
                  test_scales=['fr', 'hr'])
optimizer = dict(type="SGD", lr=0.01, momentum=0.9, weight_decay=0.0001)
lr_config = dict(step=[120000, 160000])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=180000)
checkpoint_config = dict(by_epoch=False, interval=1000, max_keep_ckpts=10000)
